...
<div><hr></div>
	<div>
		<div style="display: flex; margin: 20px; border-bottom: 1px solid #ddd; justify-content: space-between;">
			<div onclick = "location.href='${root}product?category=${order.classification}&prodNo=${order.product_no}'" style="    margin: 15px"><img src = "/product_img/${order.productImg}" style="width:144px; height: 144px"></div>
			<div style=" line-height: 3; "onclick = "location.href='${root}product?category=${order.classification}&prodNo=${order.product_no}'">
