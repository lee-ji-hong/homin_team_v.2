...
<html>
  ...
  <body>
    <div>
      <a href="/homin"
        ><img src="/product_img/logo2.png" style="height: 100px"
      /></a>
    </div>
    <hr />
    <div
      ...
      <form action="memberProc" method="post" accept-charset="utf-8">
        <table style="line-height: 3; margin: 0 auto">
          ...
          <tr>
            ...
            <td colspan="3">
              <input class="form_modify_input" type="text" name="nickname" />
            </td>
          </tr>
          ...
          <tr>
            ...
            <span style="display: none" id="msg2"
              >비밀번호는 8자리 ~ 20자리 이내로 입력해주세요.</span
            >
            <span style="display: none" id="msg3"
              >비밀번호는 공백 없이 입력해주세요.</span
            >
            <span style="display: none" id="msg4"
              >비밀번호는 영문,숫자, 특수문자를 혼합하여 입력해주세요</span
            >
          </tr>
          <tr>
            ...
            <span style="display: none" id="msg5"
              >두 패스워드가 맞지 않습니다.</span
            >
          </tr>
          <tr>
